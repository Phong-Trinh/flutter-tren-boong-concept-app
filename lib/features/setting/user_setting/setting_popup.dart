            ...
            child: Column(
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                  Text("Điểm tích lũy :  ",style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                      fontSize: 20
                  ),),
                  Text(state.user!.score.toString(),style: TextStyle(
                      color: Colors.orangeAccent,
                      fontSize: 25,
                      fontStyle: FontStyle.italic
                  ),),
                  SizedBox(width: 30,height: 30,child: Image.asset("assets/icon/point-coin.png",),)
                ],),
                SizedBox(width: 10,height: 10,),
            Column(
              children: [
                Text("Đưa mã này cho nhân viên của bạn",style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold
                ),),
                ...
                Container(
                  ...
                  child: Container(child: BarcodeWidget(
